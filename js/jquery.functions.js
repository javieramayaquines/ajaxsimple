	...
	function ActualizarDatos(){
		var alumno_id = $('#alumno_id').attr('value');
		...
		$.ajax({
			url: 'actualizar.php',
			type: "POST",
			data: "submit=&nombres="+nombres+"&ciudad="+ciudad+"&alternativas="+alternativas+"&telefono="+telefono+"&fecha_nacimiento="+fecha_nacimiento+"&alumno_id="+alumno_id,
	...
	function EliminarDato(alumno_id){
